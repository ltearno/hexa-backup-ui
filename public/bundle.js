...
<div class='mui-container'>
    <div class="mui--text-center">
        <h2 x-id="title"></h2>
        <div x-id="items" class="pui-panel" style="display: inline-block;"></div>
    </div>
</div>`;
