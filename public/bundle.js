...
function show(item, unroller) {
    ...
    element.image.src = Rest.getShaContentUrl(item.sha, item.mimeType, item.name, true, false);
}
exports.show = show;
