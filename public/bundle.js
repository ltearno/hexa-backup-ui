...
class AudioJukebox {
    ...
    realRefreshPlaylist() {
        ...
        if (this.largeDisplay) {
            ...
            html += `<div class="mui--text-dark-secondary"><label>Play immediately <input x-id='play-immediately' ${this.playImmediately ? 'checked' : ''} type="checkbox"/></label></div>`;
        }
        else {
