...
function show(item) {
    ...
    var childEl = UiTool.elFromHtml(`
        <div class="mui-container">
            <div class='mui-panel'>
                <div class="mui--text-title">'${item.name}' details</div>
                <div class="mui-divider"></div>
                <div>sha: ${item.sha}</div>
                <div>mime type: ${item.mimeType}</div>
