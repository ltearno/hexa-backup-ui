...
<div class='mui-container'>
    <div class="mui--text-center">
        ...
        <input x-id="interval" type="range" min="0" max="10"/>
...
function create() {
    ...
    (async () => {
        ...
        while (true) {
            ...
            let results = await Rest.searchEx(searchSpec);
            els.items.innerText = JSON.stringify(results);
        }
    })();
    return els;
}
